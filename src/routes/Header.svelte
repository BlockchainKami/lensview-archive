...
<!--                        <button class="bg-gradient-to-r from-amber-500 to-pink-500 text-white rounded-full font-semibold px-8 py-4 hover:bg-indigo-400 focus:bg-indigo-600 focus:outline-none">Search</button>-->
<!--                    </form>-->
